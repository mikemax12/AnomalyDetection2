# -*- coding: utf-8 -*-
"""Copy of test tubes Vanilla ae future frame recon.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1lvGlWoDqLQHkFnt6DdXisbkIm03UqUVc
"""
...
class Decoder(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        tensorDeconv3 = self.moduleDeconv3(tensorConv)
...
train_folder = "Renamed_Video_Project"
...
for epoch in range(epochs):
    ...
    for j,(imgs) in enumerate(train_batch):
        ...
        outputs,fea =  model.forward(imgs[:,0:12], True)
    ...
    print('Epoch:', epoch+1)
    if method == 'pred':
        print('Loss: Prediction {:.6f}'.format(loss_pixel.item()))
    else:
